      ...
      <div className="border-8 border-red-400 rounded-2xl flex flex-col gap-y-16 py-16 px-8">
        <div className="flex flex-col items-center md:flex-row-reverse md:items-start gap-8">
          ...
          <FoodTypeSection>
            <div>
              <FoodType>
                Signature Dogs <span className="font-redaction">$8</span>
              </FoodType>
            ...
            <div>
              <FoodName>New York &ldquo;Street Cart&rdquo; Style</FoodName>
              <FoodDescription>
            ...
            <div>
              <FoodName>Sweet Soy & Slaw</FoodName>
              <FoodDescription>
        ...
        <div className="flex flex-col items-center md:flex-row gap-8">
          ...
          <FoodTypeSection>
            ...
            <div>
              ...
              <p className="text-sm">
                (Single $13; Double $16; Bacon +$3; Egg<sup>*</sup> +$2)
              </p>
            </div>
          </FoodTypeSection>
        </div>
